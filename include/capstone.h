...
/*
 resembles function cs_disasm,
 stop disassembling at instructions that indicates end of a subroutine, 
 i.e., 
 1) b	#0x79362c                //$a
 2) pop	{r4, r5, r6, r7, pc}     //$t
 3) b.w	#0x790ef0                //$t
 4) bx	lr                       //$t
 5) ldr pc,
 */
/*
CAPSTONE_EXPORT
size_t cs_disasm_subroutine(csh handle,
                const uint8_t *code,
                uint64_t address,
                size_t count,
                cs_insn **insn);
